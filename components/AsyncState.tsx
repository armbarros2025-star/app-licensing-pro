...
export const LoadingState: React.FC<{ label?: string }> = ({ label = 'Carregando dados...' }) => (
  <div role="status" aria-live="polite" className="glass-card rounded-[2.5rem] border-white/20 p-12 text-center">
...
export const ErrorState: React.FC<{
  ...
  <div role="alert" aria-live="assertive" className="glass-card rounded-[2.5rem] border-rose-200/60 bg-rose-50/50 p-10 text-center dark:border-rose-900/40 dark:bg-rose-900/10">
...
export const EmptyState: React.FC<{
  ...
  <div className="glass-card rounded-[2.5rem] border-white/20 p-12 text-center">
