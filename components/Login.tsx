...
const Login: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07162d] px-4 py-5 transition-colors duration-200 sm:px-6 lg:px-10">
      <div aria-hidden="true" className="absolute inset-y-0 left-0 hidden w-1/2 bg-[#302bcc] lg:block" />
      <main className="relative z-10 mx-auto grid min-h-[calc(100vh-2.5rem)] w-full max-w-xl grid-cols-1 overflow-hidden rounded-2xl bg-[#07162d] lg:max-w-7xl lg:grid-cols-2">
        ...
        <section className="flex min-h-full w-full items-center justify-center bg-[#07162d] px-8 py-16 text-white sm:px-14">
          <div className="mx-auto w-full max-w-sm">
            <div className="mb-10 text-left">
              ...
              <p className="mt-5 text-4xl font-bold tracking-[-0.03em] text-white sm:text-5xl">Licensing Pro</p>
              <h2 className="mt-4 text-2xl font-semibold tracking-[-0.02em] text-[#b8c9e4]">Bem-vindo de volta</h2>
            </div>

            <form className="mx-auto w-full space-y-6" onSubmit={handleLogin} aria-busy={loading}>
            <div className="space-y-2">
              <label htmlFor="licensing-email" className="block text-sm font-medium text-[#d9e5f8]">E-mail corporativo</label>
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#8fa8d0]" />
                <input
                  id="licensing-email"
                  type="email"
                  value={email}
                  ...
                  className="w-full rounded-lg border border-[#24466f] bg-[#0b1d39] py-4 pl-12 pr-4 text-sm font-medium text-white placeholder:text-[#8fa8d0] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#73a0ff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#07162d]"
                />
              </div>
            </div>

            <div className="space-y-2">
              <label htmlFor="licensing-password" className="block text-sm font-medium text-[#d9e5f8]">Senha de acesso</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#8fa8d0]" />
                <input
            ...
            <div className="space-y-3 pt-2">
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#2859d6] py-4 text-sm font-semibold text-white transition-colors hover:bg-[#3868e5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#73a0ff] focus-visible:ring-offset-2 focus-visible:ring-offset-[#07162d] disabled:cursor-not-allowed disabled:opacity-70"
              >
            ...
            <div className="mt-12 flex items-center justify-center gap-2 text-sm font-medium text-[#b9d7ff]">
